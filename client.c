            ...
            if (strcmp("Authentication Successful", auth_buffer) == 0)
            {
                while (1)
                {
                    ...
                    case 2:
                        ...
                        printf("clinet 93 deposit:%s", deposit_buf);
                        char deposit_buff2[1024];
                        int rec_dp2 = recv(clientSocket,deposit_buff2,sizeof(deposit_buff2),0);
                        deposit_buff2[rec_dp2] = '\0';
                        printf("client 97 deposit:%s\n",deposit_buff2);
                        break;
                    case 3:
                        ...
                        printf("client 103 withdrwa:%s", withdraw_buff);
                        char withdraw_buff2[1024];
                        int rec_withdraw2 = recv(clientSocket,withdraw_buff2,sizeof(withdraw_buff2),0);
                        printf("client 110 withdraw : %s",withdraw_buff2);
                        break;
                    case 4:
